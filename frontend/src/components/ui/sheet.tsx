...
// Header
export type SheetHeaderProps = React.HTMLAttributes<HTMLDivElement> & { className?: string };
...
// Footer
export type SheetFooterProps = React.HTMLAttributes<HTMLDivElement> & { className?: string };
